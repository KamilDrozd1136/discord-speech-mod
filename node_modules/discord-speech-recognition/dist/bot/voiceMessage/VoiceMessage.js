...
const fs = require('fs');
const { getCurrentSampleRate } = require('../../../../../speechAPI');
...
class VoiceMessage {
    ...
    async saveToFile(filename) {
        ...
        const outputFile = new wav_1.default.FileWriter(filename, VoiceMessage.audioBufferFormat);
        ...
        ffmpeg(filename)
            ...
            .on('end', function () {
                ...
                }, 1000); // Wait for 1 second before deleting the file
            })
            .run();
    }
    ...
    getWavEncodedToBase64Audio() {
        const writer = new wav_1.default.Writer(VoiceMessage.audioBufferFormat);
