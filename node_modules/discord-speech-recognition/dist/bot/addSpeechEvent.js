...
const azure_1 = require("../speechRecognition/msa");
...
const speechRecognitionFunctions = {
    1: googleV2_1.resolveSpeechWithGoogleSpeechV2,
    2: azure_1.resolveSpeechWithAzureSpeechToText,
    3: witai_1.resolveSpeechWithWitai
};

const addSpeechEvent = (client, options, apiNumber) => {
    const defaultOptions = {
        lang: "pl-PL",
        speechRecognition: speechRecognitionFunctions[apiNumber],
        ignoreBots: true,
