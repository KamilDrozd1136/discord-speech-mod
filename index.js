...
// 
//const pythonProcess = spawn('python', ['lemma.py'], {
//    detached: true,
//    stdio: 'ignore'
//});
//pythonProcess.unref();
...
/**
 * The `lemmatizeText` function processes and lemmatizes the given text.
 * It sends a POST request to a locally hosted server,
 * passing the text to be lemmatized. The server performs the lemmatization and returns the result.
 * 
 * @param {string} input - The text that needs to be lemmatized.
 * @param {function} callback - A callback function that will be executed with the result of the lemmatization process.
 */
